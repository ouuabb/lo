...
const SECTIONS = {
  ...
  list: {
    ...
    description: [
      ...
      '',
      '相关命令: lo files, lo show'
    ]
  },

  files: {
    title: 'files — 列出可操作文件（文件视图）',
    usage: 'lo files [--type <类型>] [--status] [--tag <标签>] [--limit <数量>] [--format <格式>]',
    description: [
  ...
  resource: {
    ...
    description: [
      ...
      '',
      '相关命令: lo container promote, lo docs resource-container'
    ]
  },

  container: {
    title: 'container — 容器管理',
    usage: 'lo container <promote|status|scan|sync|list|members|config|ignore|unignore|member|history|transaction|verify> [选项...]',
    description: [
      ...
      '工作机制:',
      '',
      '  Container 拥有独立的成员同步体系，不参与 lo status/add/commit 流程。',
      '  分水岭是 lo container promote：只有当 File Member 被提升为',
      '  Resource 后，才进入 lo 的资源管理管线。',
      '',
      '示例:',
  ...
  plugin: {
    title: 'plugin — 插件系统管理（Phase 6.1）',
    usage: 'lo plugin <list|enable|disable|reload|info> [id]',
    description: [
      '管理 lo 插件系统的插件加载、启用和禁用。',
      '',
      '插件系统提供可扩展的模块化能力，支持插件生命周期管理、',
      '扩展点注册和上下文隔离。',
      '',
      '子命令:',
      '  list                 列出已加载的插件',
      ...
      '',
      '相关命令: lo event, lo docs plugin'
    ]
  },

  event: {
    title: 'event — 事件总线（Phase 6.2）',
    usage: 'lo event <list|history|listeners|replay> [选项...]',
    description: [
      '查看和管理 lo 事件总线系统。',
      '',
      '事件总线基于发布-订阅模式，支持中间件链和事件持久化。',
      '所有资源变更、同步操作等都通过事件总线广播。',
      '',
      '子命令:',
      ...
      '',
      '相关命令: lo plugin, lo docs event'
    ]
  },

  workflow: {
    title: 'workflow — 工作流引擎（Phase 6.3）',
    usage: 'lo workflow <list|run|status|history> [选项...]',
    description: [
      '管理工作流定义和运行实例。',
      '',
      '工作流引擎提供步骤模型、条件引擎和调度器，',
      '支持定义和执行复杂的自动化流程。',
      '',
      '子命令:',
      '  list              列出所有工作流定义',
      ...
      '',
      '相关命令: lo automation, lo docs workflow'
    ]
  },

  permission: {
    title: 'permission — 权限管理（Phase 6.4）',
    usage: 'lo permission <role|check|grant|audit> [选项...]',
    description: [
      '管理知识库的访问控制和权限。',
      '',
      '权限系统基于 RBAC+ABAC 混合模型，支持角色管理、',
      '资源级 ACL 和审计日志。',
      '',
      '子命令:',
      '  role list                   列出所有角色',
      ...
      '',
      '相关命令: lo docs permission'
    ]
  },

  agent: {
    title: 'agent — 知识智能体（Phase 6.5）',
    usage: 'lo agent <list|info|run|memory|messages|send> [选项...]',
    description: [
      '管理知识智能体（Knowledge Agent）。',
      '',
      '智能体系统支持多种 Agent 类型、独立状态机、记忆系统和',
      '规划/执行/反思循环。',
      '',
      '子命令:',
      '  list                    列出所有 Agent',
      ...
      '',
      '相关命令: lo team, lo ai, lo docs agent'
    ]
  },

  team: {
    title: 'team — Agent 团队协作（Phase 6.6）',
    usage: 'lo team <list|run> [选项...]',
    description: [
      '管理多智能体团队协作。',
      '',
      '团队协作系统提供消息模型、团队管理、任务分配和',
      '共享记忆，支持多个 Agent 协同完成复杂任务。',
      '',
      '子命令:',
      '  list              列出 Agent 团队',
      ...
      '',
      '相关命令: lo agent, lo docs collaboration'
    ]
  },

  ai: {
    title: 'ai — AI 原生知识操作系统（Phase 6.7）',
    usage: 'lo ai <status|ask|analyze|insights|memory> [选项...]',
    description: [
      'AI 原生知识操作系统，提供语义理解、推理和对话能力。',
      '',
      '包括 AI 请求/响应模型、推理引擎、语义记忆、',
      '概念记忆和学习引擎。',
      '',
      '子命令:',
      '  status              查看 AI OS 状态',
      ...
      '',
      '选项 (ask):',
      '  --mode    模式: chat/analysis/research/creation/automation',
      '             默认: chat',
      '',
      '示例:',
      '  lo ai status                                   # 查看状态',
      ...
      '  lo ai memory                                   # AI 记忆',
      '',
      '相关命令: lo agent, lo evolution, lo docs ai-os'
    ]
  },

  evolution: {
    title: 'evolution — 知识系统自演化（Phase 6.8）',
    usage: 'lo evolution <status|analyze|run|history>',
    description: [
      '知识系统自演化引擎，基于 OODA 循环实现系统的自我改进。',
      '',
      '循环流程: Observe → Analyze → Detect → Plan → Execute →',
      'Validate → Remember → Repeat。系统自动观察知识库状态、',
      '分析健康度、检测改进机会、生成策略、执行演化并验证效果。',
      '',
      '子命令:',
      '  status     查看当前进化状态',
      '  analyze    分析系统并诊断问题',
      ...
      '',
      '相关命令: lo ai, lo knowledge, lo docs evolution'
    ]
  },

  knowledge: {
    title: 'knowledge — 知识智能分析（Phase 5.7~5.11）',
    usage: 'lo knowledge <analyze|gaps|recommend|timeline|lifecycle|repair|ai|evolution|patterns|strategy|snapshot> [选项...]',
    description: [
      '知识智能分析套件，提供知识图谱的深度分析和优化建议。',
      '',
      '子命令:',
      '  analyze                  知识分析报告（密度、孤岛、缺口）',
      '  gaps                     知识缺口检测',
      '  recommend <resource>     智能推荐（关联知识 + 下一步学习）',
      '  timeline                 知识演化时间线',
      '  lifecycle                知识生命周期状态',
      '  repair                   知识修复诊断（断裂/孤立/重复）',
      '  ai                        AI 知识助手子命令组',
      ...
      '  snapshot                 创建知识状态快照',
      '',
      'AI 子命令 (lo knowledge ai):',
      '  explain <resource>      AI 解释资源在知识图谱中的位置',
      '  summarize <resource>    AI 为资源生成摘要',
      '  ask [query]             AI 知识问答',
      '',
      '示例:',
      ...
      '',
      '相关命令: lo evolution, lo ai, lo docs knowledge'
    ]
  },

  suggestion: {
    title: 'suggestion — AI 建议管理（Phase 5.8）',
    usage: 'lo suggestion <list|approve|execute|reject> [选项...]',
    description: [
      '管理 AI 生成的建议，支持审批、执行和拒绝流程。',
      '',
      'AI 辅助知识图谱通过语义分析自动生成链接建议、',
      '分类建议等，用户可通过此命令管理。',
      '',
      '子命令:',
      '  list              查看建议列表',
      ...
      '  lo suggestion execute sug_001            # 执行建议',
      '  lo suggestion reject sug_002             # 拒绝建议',
      '',
      '相关命令: lo knowledge, lo docs knowledge'
    ]
  },

  automation: {
    title: 'automation — 知识自动化（Phase 5.9）',
    usage: 'lo automation run',
    description: [
      '运行完整自动化管线，一站式执行知识库维护任务。',
      '',
      '自动化管线包括: 生命周期检查 + 修复诊断 + AI 建议生成，',
      '通过调度器和观察器自动执行。',
      '',
      '示例:',
      '  lo automation run               # 运行完整自动化管线',
      '',
      '相关命令: lo knowledge repair, lo workflow'
    ]
  },

  federation: {
    title: 'federation — 联邦仓库管理（Phase 5.10）',
    usage: 'lo federation <list|add|remove> [选项...]',
    description: [
      '管理分布式知识图谱的联邦仓库。',
      '',
      '联邦系统支持跨仓库的知识图谱查询和资源同步，',
      '基于 GlobalRID 实现全局唯一标识。',
      '',
      '子命令:',
      '  list                          列出已注册的联邦仓库',
      '  add <path>                    注册联邦仓库',
      ...
      '',
      '相关命令: lo graph query-federated, lo docs federation'
    ]
  }
};
...
function printOverview() {
  ...
  const categories = [
    ...
    { name: '知识智能', cmds: ['knowledge', 'suggestion', 'automation', 'federation'] },
